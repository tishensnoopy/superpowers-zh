  ...
  return (
    <div className="relative inline-block">
      <select
        ...
        className="appearance-none pl-4 pr-10 py-2 rounded-xl border border-border bg-card text-[#4A5568] text-sm cursor-pointer focus:outline-none focus:border-[var(--brand-primary,#F5851F)] focus:ring-2 focus:ring-[var(--brand-primary,#F5851F)]/20 transition-all"
